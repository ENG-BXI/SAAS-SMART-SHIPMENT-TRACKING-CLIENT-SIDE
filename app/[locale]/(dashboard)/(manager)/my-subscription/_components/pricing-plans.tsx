...
export default function PricingPlans({currentPlan, status, plans}: PricingPlansProps) {
  ...
  return (
    <>
      ...
      <RenewSubscriptionDialog open={renewOpen} onOpenChange={setRenewOpen} subscriptionTypeId={selectedSubscriptionTypeId} />
    </>
  );
}
