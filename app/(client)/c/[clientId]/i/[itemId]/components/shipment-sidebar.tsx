...
import {shipment, contactLabel} from './shipment-data';
        ...
        <CardContent className='space-y-4'>
          <div className='rounded-[24px] bg-white p-4 shadow-sm ring-1 ring-slate-200'>
            <div className='flex items-center justify-between gap-4'>
              <div>
                ...
                <p className='mt-2 text-2xl font-semibold text-slate-950'>{shipment.status}</p>
              </div>
          ...
          <div className='rounded-[24px] bg-white p-4 shadow-sm ring-1 ring-slate-200'>
            <div className='flex items-center justify-between gap-3'>
              ...
              <span className='text-lg font-semibold text-slate-950'>{shipment.way.points.length}</span>
            </div>
            <div className='mt-3 grid gap-2 rounded-3xl bg-slate-50 p-3 text-sm text-slate-500'>
              {shipment.way.points.map(point => (
